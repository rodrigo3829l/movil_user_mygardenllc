  ...
  <IonPage>
    <IonContent fullscreen>
      ...
      <div
        ...
        style="
          background-image: url(&quot;https://res.cloudinary.com/dui4i9f4e/image/upload/v1697990498/logos/p3xyl9xetmmg6vlamwkt.jpg&quot;);
        "
      ></div>
        ...
        <IonRow class="justify-center">
          <IonCol size="12" size-md="8">
            ...
            >
              ...
              ></IonIcon>
              <!-- <IonIcon :icon="showPassword ? 'eye' : 'eye-off'" class="text-3xl transition-transform duration-300" :class="{'rotate-180': showPassword}" @click="togglePasswordVisibility"></IonIcon> --> </IonInput
            ><br />

            <!-- Enlace de Forgot Password alineado a la izquierda -->
            <IonText>
              <a
                href="https://mygardenllcservices.com/login/mail"
                target="_blank"
                class="text-sm text-[#86A286] block mt-2"
                >Forgot password?</a
              > </IonText
            ><br />
            ...
            <IonRow class="justify-center">
              <IonText>
                <p class="text-sm text-black">
                  New user?
                  <a
                    href="https://mygardenllcservices.com/login/reistration"
                    target="_blank"
                    class="font-bold text-[#86A286]"
                    >Sign Up</a
                  >
                </p>
              </IonText>
...
import { useAuthStore } from "@/store/index"; // Usa el store de Pinia
import {
  IonPage,
  IonContent,
  IonButton,
