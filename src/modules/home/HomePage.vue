...
<IonPage>
    <IonContent fullscreen>
        <!-- Imagen de fondo -->
        <div class="relative h-[500px] bg-cover bg-center" style="background-image: url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT5--8IGy0OGa8nmcYwbg6XvPxtOVd4sauvrg&s');">
            <!-- Icono de flecha atrás -->
            <IonIcon name="arrow-back-outline" class="absolute top-5 left-5 text-black text-2xl"></IonIcon>

            <!-- Texto de bienvenida centrado -->
            <div class="absolute inset-0 flex flex-col items-center justify-center px-5">
                <h1 class="text-white text-4xl font-bold mb-2 text-center">Welcome to My Garden</h1>
                <p class="text-white text-lg mb-4 text-center">Get ready to explore the world of gardening with us.</p>
        ...
        <div class="px-5 py-8">
            ...
            <p class="mt-2 text-gray-600">
                My Garden LLC is a modern gardening company that provides high-quality plants and gardening services. Our mission is to help our customers create beautiful and sustainable outdoor spaces. We are committed to offering the best products, fast delivery, and excellent customer support.
            </p>
        </div>
                ...
                <IonRow class="justify-center">
                    <IonCol size="12" size-sm="6" size-md="4" class="ion-padding">
                        <div class="border border-gray-300 rounded-lg p-4">
                            ...
                            <p class="mt-2 text-[#86A286]">
                                Our team of experienced gardeners is dedicated to helping you achieve your gardening goals.
                            </p>
                        </div>
                    </IonCol>
                    ...
                    <IonCol size="12" size-sm="6" size-md="4" class="ion-padding">
                        <div class="border border-gray-300 rounded-lg p-4">
                            ...
                            <p class="mt-2 text-[#86A286]">
                                We prioritize customer satisfaction and go the extra mile to ensure you're happy with our products and services.
                            </p>
                        </div>
                    </IonCol>
                </IonRow>
        ...
        <div class="px-5 py-8">
            ...
            <ion-infinite-scroll threshold="100px" @ionInfinite="loadMoreComments">
                <ion-infinite-scroll-content loading-text="Loading more reviews...">
                    <div v-for="comment in displayedComments" :key="comment._id" class="mb-4">
...
import {
    Swiper,
    SwiperSlide
} from 'swiper/vue'; // Importamos los componentes de Swiper
import 'swiper/css'; // Importamos los estilos de Swiper
import SwiperCore, {
    Autoplay
} from 'swiper'; // Importamos solo el módulo Autoplay de Swiper
...
export default defineComponent({
    components: {
        ...
        IonInfiniteScroll,
        IonInfiniteScrollContent,
        BookedServices: defineAsyncComponent(() => import('@/components/BookedServices.vue')),
        CommentsServices: defineAsyncComponent(() => import('@/components/CommentsHome.vue')),
    },
    setup() {
        ...
        const fetchServices = async () => {
            try {
                ...
                usableServices.value = services.value.filter(service => service.isUsable);
            } catch (error) {
