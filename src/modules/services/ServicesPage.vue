    ...
    <IonContent fullscreen>
        ...
        <div class="filters">
            ...
            <IonItem class="select-container">
                <IonSelect label="Service Type" v-model="selectedType" interface="action-sheet" :interface-options="actionSheetOptions" color="success">
                    <IonSelectOption value="All">All</IonSelectOption>
                    <IonSelectOption v-for="(tipo, index) in types" :key="index" :value="tipo.tipo">
                        {{ tipo.tipo }}
                    </IonSelectOption>
                </IonSelect>
            </IonItem>
        ...
        <IonList v-else>
            <ServicesComponent v-for="(service, index) in paginatedServices" :key="index" :service="service" />
        </IonList>
        ...
        <div class="pagination-controls">
            ...
            <button v-if="currentPage > 2" @click="changePage(1)" class="pagination-number">
                1
            </button>

            <span v-if="currentPage > 2" class="ellipsis">...</span>

            <button v-for="page in paginationRange" :key="page" @click="changePage(page)" :class="['pagination-number', { active: currentPage === page }]">
                {{ page }}
            </button>

            <span v-if="currentPage < totalPages - 2" class="ellipsis">...</span>

            <button v-if="currentPage < totalPages - 2" @click="changePage(totalPages)" class="pagination-number">
                {{ totalPages }}
            </button>
    ...
    setup() {
        ...
        const filterServices = () => {
            ...
            if (selectedType.value !== 'All') {
                filtered = filtered.filter((service) => service.tipoDeServicio.tipo === selectedType.value);
            }
